...
public class MainClass {
    public static void Main ()
    {
            ...
            Console.WriteLine("{0} rows in Users table", myDataSet.Tables["Users"].Rows.Count);
            // The column info is automatically fetched from the database,
            // so we can read it here:
            Console.WriteLine("{0} columns in Users table", myDataSet.Tables["Users"].Columns.Count);
            DataColumnCollection drc = myDataSet.Tables["Users"].Columns;
            int i = 0;
